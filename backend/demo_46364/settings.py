"""
Django settings for demo_46364 project.
...
WSGI_APPLICATION = 'demo_46364.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_46364 API",
    "DESCRIPTION": "API documentation for demo_46364 App",
    "VERSION": "v1",
}
